...
Phone::Phone() : Phone(100, 128000, "Default Model", false, 3) {}

Phone::Phone(int batteryLevel, int storage, const std::string& model, bool screenOn, int signalStrength) {}
    : batteryLevel(batteryLevel), storage(storage), model(model), screenOn(screenOn), signalStrength(signalStrength) {}
