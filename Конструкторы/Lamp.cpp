...
Lamp::Lamp() : Lamp(60, 220, 100, 3000, false) {}

Lamp::Lamp(int power, int voltage, int brightness, int colorTemperature, bool isOn)
    : power(power), voltage(voltage), brightness(brightness), colorTemperature(colorTemperature), isOn(isOn) {}
